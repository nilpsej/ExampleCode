...
static long timeout = 0.5; //50ms timeout, in 100ms scaling
static long hold = 0.1; //10ms hold, in 100ms scaling
static long loop = 0.04; //4ms loop rate, in 100ms scaling
